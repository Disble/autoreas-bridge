export namespace contracts {
	...
	export class ScheduleMissedNotice {
	    localDate: string;
	    dueAtMs: number;
	    attemptStatus?: string;
	
	    static createFrom(source: any = {}) {
	        return new ScheduleMissedNotice(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.localDate = source["localDate"];
	        this.dueAtMs = source["dueAtMs"];
	        this.attemptStatus = source["attemptStatus"];
	    }
	}
	export class ScheduleConfig {
	    ...
	    missedNotice?: ScheduleMissedNotice;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.missedNotice = this.convertValues(source["missedNotice"], ScheduleMissedNotice);
	    }
	...
	export class ScheduleMissedActionResult {
	    kind: string;
	    localDate: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new ScheduleMissedActionResult(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.kind = source["kind"];
	        this.localDate = source["localDate"];
	        this.terminalStatus = source["terminalStatus"];
	        this.settlementReason = source["settlementReason"];
	        this.message = source["message"];
	    }
	}
...
export namespace main {
	...
	export class BackupGroupResult {
	    name: string;
	    recordCount: number;
	
	    static createFrom(source: any = {}) {
	        return new BackupGroupResult(source);
	    }
	...
	export class BackupExportResult {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.createdAt = source["createdAt"];
	        this.groups = this.convertValues(source["groups"], BackupGroupResult);
