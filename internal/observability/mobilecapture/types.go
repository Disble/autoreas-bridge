...
// Error is the structured mobile-capture failure envelope.
type Error struct {
	Code       string
	Message    string
	Retryable  bool
...
func ValidateToolName(name string) error {
	switch name {
	case "resolve_mobile_request_context", "search_mobile_requests", "get_mobile_request_context", "summary_mobile_requests":
		return nil
	default:
		return unsupportedError("unsupported mobile capture tool")
	}
}
