...
- [ ] 2.8 REFACTOR verify no producer signature changed: the six `AnimeChangedEvent` construction sites stay exactly as they are. If any of them needed editing, decision D-1 was not implemented.
